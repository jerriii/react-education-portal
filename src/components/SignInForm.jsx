...
const SignInForm = ({ customClass }) => {
  ...
  return (
    <form
      method="post"
      className={`flex flex-col gap-3 w-fit py-11 ${
    ...
    >
      <Input
        ...
        name="user_email"
        id={"user_email"}
        inputProps={{ ...register("user_email", { required: true }) }}
      >
        Email
      </Input>
      {errors.email_address && <p>Email is required.</p>}
      ...
      <div className="flex flex-row flex-nowrap w-full relative">
        <Input
          ...
          name="user_password"
          id={"user_password"}
          inputProps={{ ...register("user_password", { required: true }) }}
        >
          Password
        </Input>
        <span
